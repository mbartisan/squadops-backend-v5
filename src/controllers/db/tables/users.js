export default function makeUsersDb({ makeTable }) {
    ...
    const credentials = makeTable("users_credentials", {
        columns: [
            { key: "id", dataType: "int(11)", autoIncrement: true, primary: true },
            { key: "userId", dataType: "varchar(191)", index: true },
            { key: "type", dataType: "varchar(191)", index: true },
            { key: "hashedData", dataType: "text" },
            { key: "expiresAt", dataType: "int(11)", null: true },
            { key: "createdAt", dataType: "int(11)" },
            { key: "updatedAt", dataType: "int(11)" },
        ]
    });
