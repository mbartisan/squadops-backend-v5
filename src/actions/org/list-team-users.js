export default function makeListTeamUsers({ orgsDb, usersDb }) {
    return async function listTeamUsers(searchParameters) {
        const scopeUsers = (await orgsDb.teamUsers.query.findAll(searchParameters));
