export default function makeListRoleUsers({ orgsDb, usersDb }) {
    return async function listRoleUsers(searchParameters) {
        const scopeUsers = (await orgsDb.roleUsers.query.findAll(searchParameters));
